grecaptcha.ready(function () {
  grecaptcha.execute('6LdZEKgbAAAAAGFPYUE4RZjBVockxmsuNLf4XnCb', { action: 'homepage' }).then(function (token) {
...
$('document').ready(function () {
  ...
  $('#formulario-contacto').validate({
    ...
    messages: {
      ...
      mensaje: {
        required: 'Tu consulta es Importante',
    ...
    submitHandler: function (form) {
      ...
      if (body[0].id === 'trab-nosotros') {
        ...
        form.submit()
        alert('Formulario de presupuesto enviado correctamente Home')
      }
